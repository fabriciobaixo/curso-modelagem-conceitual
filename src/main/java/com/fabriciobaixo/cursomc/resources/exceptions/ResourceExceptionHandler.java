package com.fabriciobaixo.cursomc.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dataIntegrity(DataIntegrationException e, HttpServletRequest request){
